...
local growth_stages =
{
	{	
		name="short", 
	 	time = function(inst) return GetRandomWithVariance(TUNING.EVERGREEN_GROW_TIME[1].base, TUNING.EVERGREEN_GROW_TIME[1].random) end, 
	...
	{
		name="tall", 
		time = function(inst) return GetRandomWithVariance(TUNING.EVERGREEN_GROW_TIME[3].base, TUNING.EVERGREEN_GROW_TIME[3].random) end, 
...
local function onhackedfinal(inst)
...
local function chop_tree(inst, chopper, chops)
	...
	if chopper and chopper.components.beaverness then --and chopper.components.beaverness:IsBeaver() 
		inst.SoundEmitter:PlaySound("dontstarve/wilson/use_axe_tree")
	else
		inst.SoundEmitter:PlaySound("dontstarve/wilson/use_axe_tree")
	end
