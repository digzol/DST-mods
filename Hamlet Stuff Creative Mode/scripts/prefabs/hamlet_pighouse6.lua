...
local function MakeWindow()
    ...
    inst.AnimState:SetBank("pig_townhouse6")
...
return Prefab("hamlet_house6", fn, assets, prefabs),
    MakePlacer("hamlet_house6_placer", "pig_townhouse6", "pig_townhouse6_red_build", "idle")
