...
local walldata =
{   
	{name = "pig_ruins", 		material = "stone", tags = { "stone", "ruins" },   loot = "rocks", maxloots = 2, maxhealth = TUNING.RUINSWALL_HEALTH, buildsound = "dontstarve/common/place_structure_stone" },
}
